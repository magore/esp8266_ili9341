...
/// @brief program input mode
#define GPIO16_DIR_IN()    gpio16_ddr(0)
#define GPIO16_PIN_RD()    ( READ_PERI_REG(RTC_GPIO_IN_DATA) & 1 )
/// @brief program input mode and read
#define GPIO16_RD()        ( GPIO16_DDR_IN(), GPIO16_PIN_RD() )
...
/// @brief program output mode
#define GPIO16_DDR_OUT()   gpio16_ddr(1)
#define GPIO16_HI()        GPIO16_LATCH_HI(), GPIO16_DDR_OUT()
#define GPIO16_LOW()       GPIO16_LATCH_LOW(), GPIO16_DDR_OUT()
