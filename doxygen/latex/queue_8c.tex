...
\item 
\hyperlink{structqueue__t}{queue\+\_\+t} $\ast$ \hyperlink{queue_8c_a9bdc538e328e481eb5f5b52ba10d36b9}{queue\+\_\+new} (size\+\_\+t size)
...
size\+\_\+t \hyperlink{queue_8c_a3d73971b8454e29803ddc0763a2413c6}{queue\+\_\+used} (\hyperlink{structqueue__t}{queue\+\_\+t} $\ast$q)
\begin{DoxyCompactList}\small\item\em Find the number of bytes used by the ring buffer. \end{DoxyCompactList}\item 
size\+\_\+t \hyperlink{queue_8c_a5c47c1a42dc50ea36aab9629c4378b37}{queue\+\_\+empty} (\hyperlink{structqueue__t}{queue\+\_\+t} $\ast$q)
\begin{DoxyCompactList}\small\item\em Is the ring buffer empty ? \end{DoxyCompactList}\item 
size\+\_\+t \hyperlink{queue_8c_a6309ae001025faf270eb01c0f78c2cba}{queue\+\_\+space} (\hyperlink{structqueue__t}{queue\+\_\+t} $\ast$q)
\begin{DoxyCompactList}\small\item\em Find the amount of free space remaining in the ring buffer. \end{DoxyCompactList}\item 
size\+\_\+t \hyperlink{queue_8c_ace76ddf1f8e6b6b0d836ff6ac0255311}{queue\+\_\+full} (\hyperlink{structqueue__t}{queue\+\_\+t} $\ast$q)
\begin{DoxyCompactList}\small\item\em Is the ring buffer full ? \end{DoxyCompactList}\item 
size\+\_\+t \hyperlink{queue_8c_a69e47095291acc128fa52906bfe5cebf}{queue\+\_\+push\+\_\+buffer} (\hyperlink{structqueue__t}{queue\+\_\+t} $\ast$q, \hyperlink{send_8c_aba7bc1797add20fe3efdf37ced1182c5}{uint8\+\_\+t} $\ast$src, size\+\_\+t size)
...
size\+\_\+t \hyperlink{queue_8c_aff31d44fd9a36c7e59740485c6142f4f}{queue\+\_\+pop\+\_\+buffer} (\hyperlink{structqueue__t}{queue\+\_\+t} $\ast$q, \hyperlink{send_8c_aba7bc1797add20fe3efdf37ced1182c5}{uint8\+\_\+t} $\ast$dst, size\+\_\+t size)
...
int \hyperlink{queue_8c_a918e9bab1d67104964e167722a4d3793}{queue\+\_\+pushc} (\hyperlink{structqueue__t}{queue\+\_\+t} $\ast$q, \hyperlink{send_8c_aba7bc1797add20fe3efdf37ced1182c5}{uint8\+\_\+t} c)
...
\subsubsection[{\texorpdfstring{queue\+\_\+empty(queue\+\_\+t $\ast$q)}{queue_empty(queue_t *q)}}]{\setlength{\rightskip}{0pt plus 5cm}size\+\_\+t queue\+\_\+empty (
\begin{DoxyParamCaption}
\item[{{\bf queue\+\_\+t} $\ast$}]{q}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{queue\+\_\+full(queue\+\_\+t $\ast$q)}{queue_full(queue_t *q)}}]{\setlength{\rightskip}{0pt plus 5cm}size\+\_\+t queue\+\_\+full (
\begin{DoxyParamCaption}
\item[{{\bf queue\+\_\+t} $\ast$}]{q}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{queue\+\_\+pop\+\_\+buffer(queue\+\_\+t $\ast$q, uint8\+\_\+t $\ast$dst, size\+\_\+t size)}{queue_pop_buffer(queue_t *q, uint8_t *dst, size_t size)}}]{\setlength{\rightskip}{0pt plus 5cm}size\+\_\+t queue\+\_\+pop\+\_\+buffer (
\begin{DoxyParamCaption}
\item[{{\bf queue\+\_\+t} $\ast$}]{q, }
...
\subsubsection[{\texorpdfstring{queue\+\_\+push\+\_\+buffer(queue\+\_\+t $\ast$q, uint8\+\_\+t $\ast$src, size\+\_\+t size)}{queue_push_buffer(queue_t *q, uint8_t *src, size_t size)}}]{\setlength{\rightskip}{0pt plus 5cm}size\+\_\+t queue\+\_\+push\+\_\+buffer (
\begin{DoxyParamCaption}
\item[{{\bf queue\+\_\+t} $\ast$}]{q, }
...
\subsubsection[{\texorpdfstring{queue\+\_\+space(queue\+\_\+t $\ast$q)}{queue_space(queue_t *q)}}]{\setlength{\rightskip}{0pt plus 5cm}size\+\_\+t queue\+\_\+space (
\begin{DoxyParamCaption}
\item[{{\bf queue\+\_\+t} $\ast$}]{q}
\end{DoxyParamCaption}
...
\subsubsection[{\texorpdfstring{queue\+\_\+used(queue\+\_\+t $\ast$q)}{queue_used(queue_t *q)}}]{\setlength{\rightskip}{0pt plus 5cm}size\+\_\+t queue\+\_\+used (
\begin{DoxyParamCaption}
\item[{{\bf queue\+\_\+t} $\ast$}]{q}
\end{DoxyParamCaption}
