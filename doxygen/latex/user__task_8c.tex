...
Referenced by cat(), copy(), fatfs\+\_\+ls(), fatfs\+\_\+scan\+\_\+files(), fgetc(), fputc(), hexdump(), ls(), mmc\+\_\+test\+\_\+timeout(), sum(), testpage(), tft\+\_\+bit\+\_\+blit(), tft\+\_\+fill\+Rect\+W\+H(), tft\+\_\+floodline(), tft\+\_\+read\+Rect(), tft\+\_\+write\+Rect(), timetests(), uart1\+\_\+getc(), uart\+\_\+getb(), uart\+\_\+getc(), uart\+\_\+putb(), wait\+\_\+send(), and wire\+\_\+draw().
