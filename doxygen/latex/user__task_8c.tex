...
Referenced by fatfs\+\_\+cat(), fatfs\+\_\+ls(), fatfs\+\_\+scan\+\_\+files(), fgetc(), fputc(), mmc\+\_\+test\+\_\+timeout(), tft\+\_\+bit\+\_\+blit(), tft\+\_\+fill\+Rect\+W\+H(), tft\+\_\+floodline(), tft\+\_\+read\+Rect(), tft\+\_\+write\+Rect(), timetests(), uart1\+\_\+getc(), uart\+\_\+getb(), uart\+\_\+getc(), uart\+\_\+putb(), wait\+\_\+send(), and wire\+\_\+draw().
